...
var spriteSheets = {
    ...
    imagePath = {
        ...
        buyProduct: "btn-buy-product.png"
...
ig.module("game.entities.game-control")
    ...
    .defines(function () {
        EntityGameControl = ig.Entity.extend({
            ...
            imageWareHouse1: new ig.Image(imagePath.warehouse1),
            ...
            imageBuyProduct: new ig.Image(imagePath.buyProduct),
            ...
            draw: function () {
                if (this.gamepause == 0) {
                    ...
                    if (this.isUpdateWarehouse == 1) {
                        this.drawUpdateWareHouseButton();
                    }
            ...
            updateArrowXport: 300,
            updateArrowXLand: 570,
            drawUpdateWareHouseButton: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    var b = ig.system.context;
                    b.save();
                    b.translate(370, 140);
                    ...
                    if (this.updateArrowAnimationControlling == 0) {
                        ...
                        if (this.updateArrowXport >= 320) {
                            this.updateArrowAnimationControlling = 1;
                        }
                    } else {
                        this.updateArrowXport -= 0.3;
                        if (this.updateArrowXport <= 300) {
                            this.updateArrowAnimationControlling = 0;
                        }
                    }
                    b.translate(this.updateArrowXport, 175);
                    ...
                    if (this.updateArrowAnimationControlling == 0) {
                        ...
                        if (this.updateArrowXLand >= 590) {
                            this.updateArrowAnimationControlling = 1;
                        }
                    } else {
                        this.updateArrowXLand -= 0.3;
                        if (this.updateArrowXLand <= 570) {
                            this.updateArrowAnimationControlling = 0;
                        }
                    }
                    b.translate(this.updateArrowXLand, 80);
                    b.rotate(-90 * Math.PI / 180);
                    b.scale(0.8, 1);
                    this.imageTutorialArrow.draw(-this.imageTutorialArrow.width/2, -this.imageTutorialArrow.height/2);
                    b.restore();
            ...
            drawWareHouse: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    if (this.isUpdateWareHousedraw == 1) {
                        var b = ig.system.context;
                        b.save();
                        b.scale(0.3, 0.4);
                        b.translate(880, -260);
                        this.imageWareHouse1.draw(0, 0);
                        b.restore();
                    } else {
                        var b = ig.system.context;
                        b.save();
            ...
            UpdateButton: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    if (ig.input.mouse.x >= 216 && ig.input.mouse.x <= 306) {
                        if (ig.input.mouse.y >= 66 && ig.input.mouse.y <= 110) {
                            ig.input.mouse.x = 0;
                            ig.input.mouse.y = 0;
                    ...
                    if (ig.input.mouse.x >= 316 && ig.input.mouse.x <= 381) {
                        if (ig.input.mouse.y >= 16 && ig.input.mouse.y <= 71) {
                            ig.input.mouse.x = 0;
                            ig.input.mouse.y = 0;
                            this.isUpdateWarehouse = 0;
                            this.isUpdateWareHousedraw = 1;
